...
var app = angular.module("PostmanApp", ["ngRoute"]).config(function($routeProvider) {
    $routeProvider
        ...
        .when("/integrations/computerAttacksStats", {
            controller: "computerAttacksCtrl",
            templateUrl: "/ui/v1/companies/integrations/computerAttacks.html"
        })
        ...
        }).when("/integrations/disaster", {
            controller: "C6",
            templateUrl: "/ui/v1/computer-attacks-stats/integrations/disaster.html"
        });
});
